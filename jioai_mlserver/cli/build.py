...
def generate_dockerfile(http_proxy:str, https_proxy:str, no_proxy:str, PIP_TRUSTED_HOST:str, PIP_EXTRA_INDEX_URL:str) -> str:
    return DockerfileTemplate.format(version=__version__, http_proxy=http_proxy, https_proxy=https_proxy, no_proxy=no_proxy, PIP_TRUSTED_HOST=PIP_TRUSTED_HOST, PIP_EXTRA_INDEX_URL=PIP_EXTRA_INDEX_URL)
