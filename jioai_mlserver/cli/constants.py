...
FROM jioaicr.azurecr.io/jioai/vision/model/mlserver-python38-gpu:{version}-slim
SHELL ["/bin/bash", "-c"]
...
RUN ./hack/build-env.sh . {PIP_TRUSTED_HOST} {PIP_EXTRA_INDEX_URL} && \\
    mkdir -p ./envs/base && \\
