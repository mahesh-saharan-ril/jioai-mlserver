...
@click.option("--http-proxy", type=str, default="")
@click.option("--https-proxy", type=str, default="")
@click.option("--no-proxy", type=str, default="")
@click.option("--pip-trusted-host", type=str, default="")
@click.option("--pip-extra-index-url", type=str, default="")
@click_async
async def build(folder: str, tag: str, http_proxy:str, https_proxy:str, no_proxy:str, pip_trusted_host:str, pip_extra_index_url:str, no_cache: bool = False):
    """
    Build a Docker image for a custom MLServer runtime.
    """
    dockerfile = generate_dockerfile(http_proxy, https_proxy, no_proxy, pip_trusted_host, pip_extra_index_url)
